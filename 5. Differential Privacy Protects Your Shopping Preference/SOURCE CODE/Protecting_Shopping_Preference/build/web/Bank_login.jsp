...
<html lang="en">
    ...
    <body>
                ...
                <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="navbar-toggler-success">
                    <div class="flex-fill mx-xl-5 mb-2">
                        <ul class="nav navbar-nav mx-xl-5 text-center text-dark">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active btn-outline-primary rounded-pill px-3" href="Bank_login.jsp">Online Bank</a>
                            </li>
                            <li class="nav-item">
        ...
        <section class="container py-5"> 
            <center><h1 class="col-12 col-xl-8 h2 text-left text-primary pt-3">Bank Login!</h1></center><br><br>
            <div class="row pb-4">
                <div class="col-lg-6">
