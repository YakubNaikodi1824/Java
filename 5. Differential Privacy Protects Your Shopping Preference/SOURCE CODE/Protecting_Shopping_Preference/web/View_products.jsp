...
<html lang="en">
    ...
    <body>
                ...
                <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="navbar-toggler-success">
                    <div class="flex-fill mx-xl-5 mb-2">
                        <ul class="nav navbar-nav mx-xl-5 text-center text-dark">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active btn-outline-primary rounded-pill px-3" href="View_products.jsp">View Products</a>
                            </li>
                            <li class="nav-item">
        ...
        <section class="container py-5">
            <div class="row pb-4">
                <div class="col-lg-12">
                    <center><h1 class="feature-work-heading h2 py-3 semi-bold-600">All Proudcts</h1></center><br>
                    <br><br>
