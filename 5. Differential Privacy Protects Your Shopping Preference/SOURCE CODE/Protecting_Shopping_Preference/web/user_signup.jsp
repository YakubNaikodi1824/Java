...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="flex-fill mx-xl-5 mb-2">
                        <ul class="nav navbar-nav mx-xl-5 text-center text-dark">
                           <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active btn-outline-primary rounded-pill px-3" href="User_login.jsp">User</a>
                            </li>
                            <li class="nav-item">
        ...
        <section class="container py-5"> 
            <center><h1 class="col-12 col-xl-8 h2 text-left text-primary pt-3">User Register!</h1></center><br><br>
            <div class="row pb-4">
                <div class="col-lg-6">
                    <img src="img/reg.jpg" width="400" height="400" />
                </div>
                <div class="col-lg-5">
                    <form class="contact-form row" method="post" action="user_reg" role="form">
                        ...
                        <div class="col-12">
                            <div class="form-group mb-4">
                                <label>Email :</label>
                                <input type="email" class="form-control form-control-lg light-300" name="email" placeholder="Enter Your Email" required="required" />
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group mb-4">
                                <label>Phone :</label>
                                <input type="text" class="form-control form-control-lg light-300" name="phone" placeholder="Enter Your Phone No" required="required" />
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group mb-4">
